...
Scriptname QF_DLC2WESL01_02034025 Extends Quest Hidden
...
(DLC2WB01 as DLC2WB01QuestScript).PrepTorkild(Alias_Actor1.GetActorRef())
;END CODE
EndFunction
;END FRAGMENT
...
if (!Alias_Actor1.GetActorRef().IsDead())
...
(DLC2WB01 as DLC2WB01QuestScript).ClearTorkild()
;END CODE
EndFunction
;END FRAGMENT

...
{Script for managing a large-scale ambush-based combat, keeping a fixed number of enemies active at once.}
...
; 	;Debug.Trace("Activating next enemy.")
	BattleManager.GetNthLinkedRef(currentEnemyLink).GetLinkedRef(EnemyLinkKeyword).Activate(Self)

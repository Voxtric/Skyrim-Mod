...
Scriptname DLC1_QF_DLC1WEJS02_01010AE7 Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY DungeonInsideEntrance
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_DungeonInsideEntrance Auto
;END ALIAS PROPERTY
...
Function Fragment_3()
;BEGIN CODE
Actor Vampire = alias_Vampire.GetReference() as Actor

Vampire.SetActorValue("Aggression", 2)
Vampire.SetActorValue("Confidence", 1)
;END CODE
EndFunction
;END FRAGMENT

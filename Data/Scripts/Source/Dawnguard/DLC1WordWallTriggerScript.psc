scriptName DLC1WordWallTriggerScript extends ObjectReference
{
...
Function StartFX()
	...
	;player is close enough to the word
		...
		shoutGlobal.value += 1
		;notification("global incremented to: " +shoutGlobal.value)
...
Function StartWordWall()
	...
	tracestack("registering for update")

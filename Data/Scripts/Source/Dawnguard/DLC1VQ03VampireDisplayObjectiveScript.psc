Scriptname DLC1VQ03VampireDisplayObjectiveScript extends ObjectReference  
{Display objective 41 on DLC1VQ03Vamp when the player enters on stage 60 of the quest}
...
; 						debug.trace("ERROR: "+myQuest+" not started by "+self)
				...
				myQuest.SetObjectiveDisplayed(41)
				if doOnce

...
Scriptname QF_Favor258_000A34DE Extends Quest Hidden
...
FavorJarlsMakeFriends.SetStage(90)

;Player has enough friends already
If FavorJarlsMakeFriends.GetStageDone(95)
  SetStage(20)
EndIf
;END CODE
EndFunction
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor258QuestGiverFaction)
...
Faction Property Favor258QuestGiverFaction  Auto  

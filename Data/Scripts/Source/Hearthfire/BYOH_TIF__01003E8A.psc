...
Scriptname BYOH_TIF__01003E8A Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
;Initial house will be in Falkreath...
(GetOwningQuest() as BYOHRelationshipAdoptableOrphanageSc).StoreHouseLocation(6)
;END CODE
EndFunction
;END FRAGMENT

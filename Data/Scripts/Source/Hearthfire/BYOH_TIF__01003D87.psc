...
Scriptname BYOH_TIF__01003D87 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
;Initial house will be in Riften...
(GetOwningQuest() as BYOHRelationshipAdoptableOrphanageSc).StoreHouseLocation(4)
;END CODE
EndFunction
;END FRAGMENT

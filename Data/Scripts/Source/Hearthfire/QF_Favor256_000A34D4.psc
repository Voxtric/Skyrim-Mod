...
Scriptname QF_Favor256_000A34D4 Extends Quest Hidden
...
FavorJarlsMakeFriends.SetStage(70)

;Player has enough friends already
If FavorJarlsMakeFriends.GetStageDone(75)
  SetStage(20)
EndIf
;END CODE
EndFunction
...
Alias_QuestGiver.GetActorReference().RemoveFromFaction(Favor256QuestGiverFaction)

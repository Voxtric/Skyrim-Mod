...
Scriptname BYOH_TIF__01003DA1 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
;Initial house will be in Windhelm...
(GetOwningQuest() as BYOHRelationshipAdoptableOrphanageSc).StoreHouseLocation(2)
;END CODE
EndFunction
;END FRAGMENT
